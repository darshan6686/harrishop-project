                        ...
                        <details className="group" open>
                            ...
                            <div>
                                ...
                                <div className='w-full h-32 overflow-auto mt-7 text-custom-font'>
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Logitech</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Sony</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Samsung</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Apple</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Deepcool</span> <br />
                                </div>
                            </div>
                        </details>
                    </div>
                        ...
                        <details className="group" open>
                            ...
                            <div>
                                ...
                                <div className='w-full h-40 overflow-auto mt-7 text-custom-font'>  
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Green</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Orange</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Black</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Red</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Yellow</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>white</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Pink</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Gray</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>Blue</span> <br />
                                </div>
                            </div>
                        </details>
                    </div>
                    ...
                    <div className="py-3 border-none mt-5">
                        <details className="group" open>
                            ...
                            <div>
                                <hr />
                                <div className='w-full h-40 overflow-auto mt-7 text-custom-font'>  
                                   <a href=''> <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>$10.00 - $49.00</span> <br /> </a>
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>$50.00 - $99.00</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>$100.00 - $199.00</span> <br />
                                    <input type='checkbox' className='w-4 h-4 my-2 cursor-pointer' /> <span className='ml-2 cursor-pointer'>$200.00+</span>
                                </div>
                            </div>
                        </details>
                    </div>

                    <button className='bg-custom-pink text-white h-12 font-semibold hover:bg-indigo-500 hover:duration-300'>Reset Filter</button>
