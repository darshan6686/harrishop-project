  ...
  return (
    ...
    <div className='w-11/12 2xl:w-10/12 mx-auto'>
      ...
      {data.filter((el) => {return el.type === 'top rated'}).map((ele)=>{
        return (
        <div key={ele.id} className='main-product-card h-auto w-[300px] mt-5'>
        <div className='bg-[#F6F8FA] h-[330px] w-[320px] relative'>
          ...
          <div className='h-40 w-12 z-5 three-icon right-0 me-3 mt-8 absolute duration-500'>
              ...
              <button onClick={() => dispatch(addToWhishlist(ele))} className='h-10 heart w-10 mx-auto bg-white mt-2 shadow-md border duration-500 hover:bg-custom-pink rounded-sm'><i className="fa-regular fa-heart text-xl text-gray-700 hover:text-white duration-500"></i></button>
            ...
            <div><button onClick={() => dispatch(addToCart(ele))} > <div className='addtocart h-12 w-full pt-2 bg-black text-white text-center font-semibold items-center justify-center absolute bottom-0 hover:bg-custom-pink duration-500 z-20'><i className=" me-2 fa-solid fa-cart-plus duration-500"></i>Add To Cart</div></button></div>

            <Link to='/Mycart' className=''> <div className='addtocart h-12 w-full pt-2 bg-black text-white text-center font-semibold items-center justify-center absolute bottom-0 hover:bg-custom-pink duration-500 z-10'><i className="me-2 fa-solid fa-cart-plus duration-500"></i>View cart</div></Link>
        </div>
