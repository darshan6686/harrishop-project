          ...
          <div className='h-auto sm:w-[550px] xl:w-[650px] m-auto shadow-2xl'>
              <div className='grid xl:grid-cols-1'>
                  <div className=''>
                      ...
                      <div className='border my-7 w-9/12 m-auto flex'>
                      ...
                      <div className='border my-7 w-9/12 m-auto flex'>
                          <img src={a2} className='ms-5'/>
                          <input type='password' placeholder='Confirm Password' className='py-4 ms-2 w-full text-[16px] focus:outline-none'/>
                          <img src={a1} className='me-5'/>
                      </div>
                      ...
                      <p className='text-center mb-14 mt-6 text-[#525258] text-lg'>Already have an account?<span className='text-custom-pink'><Link to='/Login'> Log in</Link></span></p>
                  </div>
              </div>
          </div>
      </div>
